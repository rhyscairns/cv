...
export const stats = [
  {
    value: 50000,
    suffix: '+',
    label: 'Colleagues using what I ship',
    prefix: '',
  },
  {
    value: 300,
    suffix: '',
    label: 'Stores running my UI nationwide',
    prefix: '',
  },
  {
    value: 2,
    suffix: 'M+',
    label: 'Marketplace products supported',
    prefix: '',
  },
  {
    value: 4,
...
export const experience = [
  ...
  },
  {
    ...
    highlights: [
      'Covered JavaScript, Node.js, ReactJS, REST APIs, relational databases and test-driven development.',
      'Placed directly onto a live production engineering team on completion.',
    ],
    stack: ['JavaScript', 'Node.js', 'ReactJS', 'REST', 'TDD', 'SQL'],
  },
  {
    id: 'rightmove',
    company: 'Rightmove',
